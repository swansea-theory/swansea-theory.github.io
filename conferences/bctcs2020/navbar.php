...
<nav class="navbar navbar-expand-lg navbar-dark bg-uniblue sticky-top">  
  ...
  <a class="navbar-brand" href="http://cs.swansea.ac.uk/bctcs2022">
    <span class="mx-3">BCTCS 2022</span>
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item <?php ifURLLastSegment('', 'active'); ?>">
        <a class="nav-link" href="/bctcs2022">Home</a>
      </li>
...
-->
      ...
      <li class="nav-item <?php ifURLLastSegment('dates', 'active'); ?>">
